...
import kotlinx.android.synthetic.main.relationship_fragment.*
import kotlinx.android.synthetic.main.tool_bar_two.*


class AthleticFragment : Fragment()
{
 ...
 */
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var rootView = inflater!!.inflate(R.layout.athletic_fragment, container, false)
        return rootView
    }
...
//            startActivity(intent)
        ...
        img_back_two.setOnClickListener(View.OnClickListener {
            val weightFragment = RelationshipTwoFragment.newInstance()
            openFragment(weightFragment)
        })
    }

    companion object {
        fun newInstance(): AthleticFragment = AthleticFragment()
    }
