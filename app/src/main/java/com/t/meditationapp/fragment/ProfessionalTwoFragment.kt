...
import com.t.meditationapp.activities.GetMore_Activity
...
class ProfessionalTwoFragment : Fragment()
{
 ...
 */
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var rootView = inflater!!.inflate(R.layout.professional_two_fragment, container, false)
        return rootView
    }
...
//        })
    ...
    companion object {
        fun newInstance(): ProfessionalTwoFragment = ProfessionalTwoFragment()
    }
