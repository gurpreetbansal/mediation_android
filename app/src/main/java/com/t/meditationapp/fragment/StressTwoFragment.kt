...
class StressTwoFragment : Fragment()
{
 ...
 */
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var rootView = inflater!!.inflate(R.layout.stress_two_fragment, container, false)
        return rootView
    }
...
//            })
    ...
    companion object {
        fun newInstance(): StressTwoFragment = StressTwoFragment()
    }
