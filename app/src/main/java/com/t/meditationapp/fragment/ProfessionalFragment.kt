 ...
 */
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        var rootView = inflater!!.inflate(R.layout.professional_fragment, container, false)
        return rootView
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        img_back_two.setOnClickListener(View.OnClickListener {
            val weightFragment = ProfessionalTwoFragment.newInstance()
            openFragment(weightFragment)
        })
    }

    companion object {
        fun newInstance(): ProfessionalFragment = ProfessionalFragment()
    }
