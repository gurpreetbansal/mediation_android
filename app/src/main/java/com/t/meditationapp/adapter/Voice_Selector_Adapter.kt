...
class Voice_Selector_Adapter(val context: Context, var listItemsTxt: Array<String>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if (convertView == null) {
            view = mInflater.inflate(R.layout.custom_row_voice_selector, parent, false)
